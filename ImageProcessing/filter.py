...
show('x edg', x_edg)
show('y edg', y_edg)
cv2.imwrite('./media/image/x_edgeCar.jpg', x_edg)
cv2.imwrite('./media/image/y_edgeCar.jpg', y_edg)
...
cv2.imwrite("./media/image/highpassCar.jpg", highpass)
